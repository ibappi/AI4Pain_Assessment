...
def plot_raw_signals(file_path, n_sessions=3):
    ...
    plt.tight_layout()
    plt.show()
example_file = os.path.join(Eda_data_dir, os.listdir(Eda_data_dir)[0])
...
plt.xlabel('Hz'); plt.ylabel('PSD'); plt.title('EDA PSD by class'); plt.legend(); plt.tight_layout(); plt.show()

# ---------------------


output_path = f'preprocessed_eda_segments_analysis_{segment_length}.csv'
